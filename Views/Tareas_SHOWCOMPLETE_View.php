<!-- TABLA QUE MUESTRA TODAS LAS TAREAS COMPLETADAS
...
?>
 ...
 <!--Tabla con todas las tareas completadas en la bd -->
        <div class="showall">             
		
            <table class="showAllUsers">
				<tr><th class="title" colspan="6"><?php echo $strings['Tareas completadas']; ?>
